...
public class ProductSpecification {
	public static Specification<Product> filter(FilterCriteria criteria) {
	...
	public static Specification<Product> filterByTaxomonyId(Integer id) {
		return (root, query, builder) -> {
			if (id == null)
				return null;
			Join<Product, Taxomony> taxomonyJoin = root.join("taxomonies");
